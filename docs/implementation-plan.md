...
- Configure Visual Parsing only through `FILE2DOC_VISUAL_MODEL`, `FILE2DOC_VISUAL_API_KEY`, `FILE2DOC_VISUAL_BASE_URL`, `FILE2DOC_VISUAL_ITEM_TIMEOUT_SECONDS`, `FILE2DOC_VISUAL_JOB_DEADLINE_SECONDS`, `FILE2DOC_VISUAL_MAX_CONCURRENCY`, `FILE2DOC_VISUAL_ARTIFACT_TTL_SECONDS`, and `FILE2DOC_VISUAL_ARTIFACT_RELEASE_GRACE_SECONDS`. The retired `FILE2DOC_OCR_*` names are not aliases.
